...
<style>
    ...
    * { margin: 0; padding: 0; box-sizing: border-box; font-family: 'Poppins', sans-serif; }
    ...
    @media (max-width: 768px) {
        .grid-2, .grid-3, .grid-4, .dashboard-split, .subtle-grid { grid-template-columns: 1fr; }
...
<!-- Header -->
        <div class="header-bar">
            ...
            <div class="header-actions">
                ...
                <a href="{{ url_for('about_system') }}" class="btn btn-info">ℹ️ About</a>
        ...
        <div class="card">
            <div class="nav-tabs">
                <button class="active" onclick="showTab('addstudent')">➕ Add Student</button>
...
<!-- Header -->
        ...
        <div class="card">
            <div class="nav-tabs">
                <button class="active" onclick="showTab('announcements')">
